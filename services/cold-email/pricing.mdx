...
<CardGroup cols={2}>
  <Card href="/pricing" title="Pricing & Plans">
    Full tier breakdown with volume options and what's included at each level.
  </Card>
  <Card href="/knowledge-base/in-house-sdrs-vs-done-for-you" title="In-House SDRs vs. Done-For-You">
    Deep comparison of building an internal team versus outsourcing cold email operations.
  </Card>
  <Card href="/knowledge-base/diy-tools-vs-managed-service" title="DIY Tools vs. Managed Service">
